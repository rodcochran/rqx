...
#           │     ├── DecodingError
#           │     └── TooManyRedirects
#           ├── HTTPStatusError        (carries .response)
#           └── MaxRetriesExceeded
#
...
class HTTPStatusError(HTTPError):
    response: PyResponse | PyStreamResponse | PyAsyncStreamResponse
...
class PyResponse:
    ...
    def json(self) -> Any: ...
    def raise_for_status(self) -> PyResponse: ...
...
class PyStreamResponse:
    ...
    def close(self) -> None: ...
    def json(self) -> Any: ...
    def raise_for_status(self) -> PyStreamResponse: ...
...
class PyAsyncStreamResponse:
    ...
    def json(self) -> Any: ...
    def raise_for_status(self) -> PyAsyncStreamResponse: ...
