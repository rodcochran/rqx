...
Read the report for the architectural trade-offs (sync vs async paths, retry placement, JSON parsing strategy, runtime singleton). For performance numbers, use the benchmark section below and [benchmarks/0.3.0/report.md](benchmarks/0.3.0/report.md).
...
![Throughput at concurrency=100](benchmarks/0.3.0/throughput.png)

![Memory at concurrency=100](benchmarks/0.3.0/memory.png)

![Median latency at concurrency=100](benchmarks/0.3.0/latency.png)
